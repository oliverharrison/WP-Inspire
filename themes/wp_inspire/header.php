...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$wp_inspire_description = get_bloginfo( 'description', 'display' );
			if ( $wp_inspire_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $wp_inspire_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
